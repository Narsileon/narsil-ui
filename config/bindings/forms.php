...
return [
    ...
    */
    ...
    \Narsil\Base\Contracts\Forms\TanStackTableForm::class => \Narsil\Base\Implementations\Forms\TanStackTableForm::class,
    \Narsil\Base\Contracts\Forms\UserForm::class => \Narsil\Base\Implementations\Forms\UserForm::class,
    \Narsil\Base\Contracts\Forms\UserBookmarkForm::class => \Narsil\Base\Implementations\Forms\UserBookmarkForm::class,
    \Narsil\Base\Contracts\Forms\UserConfigurationForm::class => \Narsil\Base\Implementations\Forms\UserConfigurationForm::class,
