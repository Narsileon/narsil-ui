...
function ComboboxChips({ className, ...props }: Combobox.Chips.Props) {
  return (
    <Combobox.Chips
      ...
      className={cn(
        "flex min-h-9 flex-wrap items-center gap-1 rounded-md border border-input bg-transparent bg-clip-padding p-1 pl-2.5 text-sm transition-colors dark:bg-input/30",
