...
const navigationMenuTriggerVariants = cva(
  cn(
    ...
    "inline-flex h-9 w-max items-center justify-center rounded-lg bg-background px-2.5 py-1.5 font-medium ring-2 ring-transparent transition-all outline-none",
