...
function DataTableSettings({ ...props }: DataTableSettingsProps) {
  ...
  function handleActivate(column: Column<DataTableData, unknown>) {
  ...
  function handleDeactivate(column: Column<DataTableData, unknown>) {
...
type SortableItemProps = {
  ...
  onRemove: (c: Column<DataTableData, unknown>) => void;
};
