...
function CalendarDayButton({ className, day, modifiers, ...props }: CalendarDayButtonProps) {
  ...
  return (
    <Button
      ...
      className={cn(
        "flex aspect-square size-auto w-full min-w-(--cell-size) flex-col gap-1 bg-red-500 leading-none font-normal",
        ...
        "group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10 group-data-[focused=true]/day:border-primary group-data-[focused=true]/day:ring-2 group-data-[focused=true]/day:ring-primary",
