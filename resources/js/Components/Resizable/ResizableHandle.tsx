...
const ResizableHandle = ({ withHandle, className, ...props }: ResizableHandleProps) => (
	<ResizablePrimitive.PanelResizeHandle
		className={cn(
			...
			"focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary-highlight focus-visible:ring-offset-1",
			...
			"data-[panel-group-direction=vertical]:after:-translate-y-1/2 data-[panel-group-direction=vertical]:after:translate-x-0 [&[data-panel-group-direction=vertical]>div]:rotate-90",
			className
		)}
		{...props}
	>
